...
namespace HolaHealth.Suite.Shared.Hosting.Microservices;
...
public class SuiteSharedHostingMicroservicesModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services
            .AddDataProtection()
            .SetApplicationName("Suite")
            .PersistKeysToStackExchangeRedis(redis, "Suite-Protection-Keys");
